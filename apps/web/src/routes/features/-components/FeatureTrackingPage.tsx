      ...
      <div className="flex gap-2.5 overflow-x-auto bg-gray-50 p-4 dark:bg-gray-900/40">
        {APPLICATION_STATUSES.map((status) => {
          ...
          return (
            <div
              key={status}
              className={`w-40 shrink-0 rounded-lg border-t-4 border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800 ${colors.columnBorder}`}
            >
    ...
    <FeaturePageLayout
      ...
      benefits={[
        ...
        },
        {
          ...
          visual: (
            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-800/50 flex gap-2">
        ...
        },
        {
          ...
          visual: (
            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-800/50 divide-y divide-gray-100 dark:divide-gray-700">
